...
public class CommonReportsParser {
	...
	private Map<String, Map<String, Object>> createAvailabilityReport(
		...
		DXTPerformanceTestingTool.printLine("Availability reports number : "
				+ getRecordsNumber(meDataValues) + "\n");
	...
	private Map<String, Map<String, Object>> createComputerUnitReport(
		...
		DXTPerformanceTestingTool.printLine("Computer unit reports number : "
				+ msgBusNumber + "\n");
		...
		for (int i = 0; i < msgBusNumber; i++) {
			...
			if (!recCondition.equals("FF")) {
				...
				DXTPerformanceTestingTool.printLine("Report for the "
						+ computerUnitName
						+ " incorrect. Do not fill other properties\n");
			}
	...
	private Map<String, Map<String, Object>> createMessageBusLoadReport(
		...
		DXTPerformanceTestingTool
				.printLine("Message Bus Load reports number : " + msgBusNumber
						+ "\n");
	...
	private Date createPeriodTime(final Date startTime,
		...
		try {
			...
			DXTPerformanceTestingTool.printLine("Can't get minute value for : "
					+ meDataValues.get(minuteByteValue) + "\n");
		}
